...
module ActiveModel
  class ArraySerializer
    ...
    attr_accessor :object, :scope, :root, :meta_key, :meta, :key_format, :context, :params, :association_chain
    ...
    def serializer_for(item)
      ...
      serializer_class.new(item, scope: scope, key_format: key_format, context: @context, only: @only, except: @except, polymorphic: @polymorphic, namespace: @namespace, params: params, association_chain: association_chain)
    end

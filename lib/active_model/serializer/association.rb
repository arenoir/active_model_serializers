...
** Notice: include was renamed to embed_in_root. **
      ...
      attr_accessor :embed_in_root, :embed_key, :key, :embedded_key, :root_key, :serializer_from_options, :options, :key_format, :embed_in_root_key, :embed_namespace, :association_chain

...
module ActionController
  module Serialization
    ...
    class ArrayEmbedingSerializerTest < ActionController::TestCase
      ...
      def test_render_array_embeding_in_root_with_single_fieldset
        @association.embed = :ids
        @association.embed_in_root = true
      ...
      # def test_render_array_with_fieldset_with_fieldsets
      #   @association.embed = :ids
      #   @association.embed_in_root = true
      ...
      #   get :render_array_embeding_in_root, include: { user: [:name], profile: [:name] }
      #   assert_equal 'application/json', @response.content_type
